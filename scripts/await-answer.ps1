...
# когда фоновая команда выходит. Выход — одна строка на любом конечном состоянии; почему —
# CLAUDE.md. Разбор файла — тот же, что у подачи и сверки, из base-check.ps1.
[CmdletBinding()]
param(
